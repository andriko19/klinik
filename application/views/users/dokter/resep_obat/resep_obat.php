  ...
  <div class="container-fluid">
    ...
    <?php if( $this->session->flashdata('message') ) : ?>
      <div class="alert alert-success alert-dismissible fade show text-center" id="flash" role="alert">
        Data resep obat<strong> berhasil </strong> <?= $this->session->flashdata('message');?>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center" width="20%">
                    <a href="<?= base_url('Dokter/tampil_detail_resep/'. $resep['kode_resep']);?>" class="btn btn-primary btn-icon-split">
